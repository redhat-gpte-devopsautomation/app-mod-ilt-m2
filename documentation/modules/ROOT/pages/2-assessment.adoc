...
Open a new browser to access the https://mta-mta-%USERID%.%SUBDOMAIN%[Tackle web console^].
...
Since this is a key application in the architecture, we’re going to set the criticality and priority to `10` and `9` respectively.
